                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control border-input" id="idcustomer">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group" style="padding-top: 25px;">
                                            <button type="button" class="btn btn-primary btn-fill btn-wd" data-toggle="modal" id="addso">Add Sales</button>
                                        </div>
                                    </div>
              ...
              <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>ID</label>
                            <input type="text" class="form-control border-input" id="idsale" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>ID Customer</label>
                            <input type="text" class="form-control border-input" id="custid" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Customer's Name</label>
                            <input type="text" class="form-control border-input" id="custname" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Date</label>
                            <input type="text" class="form-control border-input" id="dateso" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Total</label>
                            <input type="text" class="form-control border-input" id="totalso" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#addso").click(function(){
                if(!$("#tgl").val() || !$("#idcustomer").val()) {
                    alert("Please Fill the Blank");
                }
                else {
                    $("#idtemp").val($("#idcustomer").val());
            ...
            $("#tbody").on("click","tr",function(){
                ...
                $("#dateso").val(dte);
                $("#totalso").val(tot);
                $("#custid").val($(this).children("td:eq(3)").html());
                $("#custname").val($(this).children("td:eq(4)").html());
                $("#stts").val(st);
                showDetail(id);
            ...
            $.ajax({
                ...
                success:function(hasil){
                    ...
                    $.each(hasil, function(i,field){
                        $("#idcustomer").append('<option value="'+field.id+'">'+field.name+'</option>');
                    });
                }
            });
        }
        ...
        function showDetail(id){
            $.ajax({
                ...
                success:function(hasil){
                    $("#detBody").html("");
                    $.each(hasil, function(i,field){
                        $("#detBody").append("<tr><td>"+field.id+"</td><td>"+field.id_invent+"</td><td>"+field.name+"</td><td>"+field.amount+"</td><td>"+field.subtotal+"</td><td><input type='number' class='form-control border-input' min='0' max='"+field.amount+"' value='"+field.sent+"'></td></tr>");
                    });
                }
            });
        }
        function showData(){
            $.ajax({
                ...
                success:function(hasil){
                    $("#tbody").html("");
                    $.each(hasil, function(i,field){
                        $("#tbody").append("<tr><td>"+field.id+"</td><td>"+field.date+"</td><td>"+field.time+"</td><td>"+field.id_cust+"</td><td>"+field.name+"</td><td>"+field.total+"</td><td>"+field.status+"</td></tr>");
                    });
                }
            });
        }
