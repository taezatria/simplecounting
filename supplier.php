        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">New Supplier</h4>
                            <p class="category"></p>
                        </div>
                        <div class="content">
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" style="padding-top: 25px;">
                                            <button type="button" class="btn btn-primary btn-fill" id="addsupp">Add Supplier</button>
                                        </div>
                                    </div>
                                </div>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <!-- Title nya -->
                <h4 class="modal-title">Supplier's Order</h4>
              </div>
              <!-- Isi nya -->
              <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>ID</label>
                            <input type="text" class="form-control border-input" id="idsupp" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" class="form-control border-input" id="namesupp" readonly>
                        </div>
                    </div>
                </div>
              <div class="table-responsive">
